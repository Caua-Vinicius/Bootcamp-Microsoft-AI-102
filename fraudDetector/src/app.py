...
def configure_interface():
    ...
    if uploaded_file is not None:
        ...
        if blob_url:
            ...
            credit_card_info = analize_credit_card(blob_url) # Chamar a função de detecção de informações de Cartão de credito
...
def show_image_and_validation(blob_url, credit_card_info):
    ...
    if credit_card_info and credit_card_info["card_name"]:
        ...
        st.write(f"Numeros do Cartão: {credit_card_info['card_number']}")
